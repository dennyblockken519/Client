...
public class Floor1 {
   ...
   Floor1() {
      ...
      if(var1 != 1) {
         ...
         for(var4 = 0; var4 < var3; ++var4) {
            this.classDimensions[var4] = class227.method4306(3) + 1;
            var5 = this.classSubClasses[var4] = class227.method4306(2);
            if(var5 != 0) {
               this.classMasterbooks[var4] = class227.method4306(8);
            }
            ...
            for(var7 = 0; var7 < var5; ++var7) {
               var6[var7] = class227.method4306(8) - 1;
            }
         }

         this.multiplier = class227.method4306(2) + 1;
         var4 = class227.method4306(4);
         var5 = 2;
         ...
         for(var9 = 0; var9 < var2; ++var9) {
            ...
            for(int var8 = 0; var8 < this.classDimensions[var7]; ++var8) {
               this.field1376[var5++] = class227.method4306(var4);
            }
         }
   ...
   boolean method1938() {
      ...
      if(!var1) {
         ...
         for(var3 = 0; var3 < var2; ++var3) {
            xList[var3] = this.field1376[var3];
         }

         var3 = RANGES[this.multiplier - 1];
         int var4 = class211.method4098(var3 - 1);
         yList[0] = class227.method4306(var4);
         yList[1] = class227.method4306(var4);
         int var5 = 2;
         ...
         for(int var6 = 0; var6 < this.paritionClassList.length; ++var6) {
            ...
            int var11 = 0;
            if(var9 > 0) {
               var11 = class227.codeBooks[this.classMasterbooks[var7]].method964();
            }

            for(int var12 = 0; var12 < var8; ++var12) {
               int var13 = this.subclassBooks[var7][var11 & var10];
               var11 >>>= var9;
               yList[var5++] = var13 >= 0?class227.codeBooks[var13].method964():0;
            }
         }
   ...
   @ObfuscatedName("x")
   void method1947(int var1, int var2, int var3, int var4, float[] var5, int var6) {
      int var7 = var4 - var2;
      int var8 = var3 - var1;
      ...
      for(int var14 = var1 + 1; var14 < var3; ++var14) {
         ...
         var5[var14] *= field1381[var11];
      }

   }

   @ObfuscatedName("p")
   void method1939(float[] var1, int var2) {
      ...
      for(var6 = 2; var6 < var3; ++var6) {
         var7 = method1951(xList, var6);
         var8 = method1933(xList, var6);
         var9 = this.method1934(xList[var7], yList[var7], xList[var8], yList[var8], xList[var6]);
         var10 = yList[var6];
         int var11 = var4 - var9;
      ...
      for(var8 = 1; var8 < var3; ++var8) {
         if(field1378[var8]) {
            ...
            this.method1947(var6, var7, var9, var10, var1, var2);
            if(var9 >= var2) {
               return;
            }
   ...
   @ObfuscatedName("h")
   void method1935(int var1, int var2) {
      if(var1 < var2) {
         int var3 = var1;
         int var4 = xList[var1];
         int var5 = yList[var1];
         ...
         yList[var3] = var5;
         field1378[var3] = var6;
         this.method1935(var1, var3 - 1);
         this.method1935(var3 + 1, var2);
      }
   }

   @ObfuscatedName("g")
   int method1934(int var1, int var2, int var3, int var4, int var5) {
      int var6 = var4 - var2;
      int var7 = var3 - var1;
   ...
   @ObfuscatedName("a")
   static int method1951(int[] var0, int var1) {
      int var2 = var0[var1];
      int var3 = -1;
   ...
   @ObfuscatedName("s")
   static int method1933(int[] var0, int var1) {
      int var2 = var0[var1];
      int var3 = -1;
