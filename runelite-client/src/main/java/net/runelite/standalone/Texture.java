...
public class Texture extends Node implements RSTexture {
   ...
   Texture(Packet var1) {
      ...
      this.field1617 = var1.readUnsignedByte() == 1;
      ...
      if(var2 >= 1 && var2 <= 4) {
         ...
         if(var2 > 1) {
            ...
            for(var3 = 0; var3 < var2 - 1; ++var3) {
               this.field1619[var3] = var1.readUnsignedByte();
            }
         }
   ...
   boolean method534(double var1, int var3, Js5Index var4) {
      int var5;
      for(var5 = 0; var5 < this.fileIds.length; ++var5) {
         if(var4.method4124(this.fileIds[var5]) == null) {
            return false;
         }
      }
      ...
      for(int var6 = 0; var6 < this.fileIds.length; ++var6) {
         IndexedSprite var7 = ProjectileAnimation.method4007(var4, this.fileIds[var6]);
         var7.method4283();
         byte[] var8 = var7.pixels;
         int[] var9 = var7.palette;
         int var10 = this.field1622[var6];
         ...
         for(var11 = 0; var11 < var9.length; ++var11) {
            var9[var11] = Graphics3D.method2151(var9[var11], var1);
         }

         if(var6 == 0) {
            var11 = 0;
         } else {
            var11 = this.field1618[var6 - 1];
         }
   ...
   public void copy$animate(int var1) {
      if(this.pixels != null) {
         ...
         int var7;
         int[] var10;
         if(this.field1612 == 1 || this.field1612 == 3) {
            if(field1625 == null || field1625.length < this.pixels.length) {
               field1625 = new int[this.pixels.length];
            }
            ...
            for(var6 = 0; var6 < var3; ++var6) {
               var7 = var6 + var4 & var5;
               field1625[var6] = this.pixels[var7];
            }

            var10 = this.pixels;
            this.pixels = field1625;
            field1625 = var10;
         }

         if(this.field1612 == 2 || this.field1612 == 4) {
            if(field1625 == null || field1625.length < this.pixels.length) {
               field1625 = new int[this.pixels.length];
            }
            ...
            for(var6 = 0; var6 < var3; var6 += var2) {
               for(var7 = 0; var7 < var2; ++var7) {
                  ...
                  field1625[var8] = this.pixels[var9];
               }
            }
   ...
   void method536(int var1) {
      if(!ItemContainer.clientInstance.isGpu()) {
         ...
         ItemContainer.clientInstance.getDrawCallbacks().animate(this, var1);
      }
   }
}
