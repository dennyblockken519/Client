...
public class Rasterizer2D extends CacheableNode {
   ...
   @ObfuscatedName("dn")
   public static void method761(int var0, int var1, int var2, int var3, int var4, int var5) {
      if(var2 > 0 && var3 > 0) {
         int var6 = 0;
         int var7 = 65536 / var3;
   ...
   @ObfuscatedName("dy")
   static void method712(int var0, int var1, int var2) {
   ...
   @ObfuscatedName("dc")
   public static void method698(int var0, int var1, int var2, int var3) {
   ...
   @ObfuscatedName("dd")
   public static void method697(int var0, int var1, int var2, int var3, int var4, int var5) {
      method699(var0, var1, var2, var4, var5);
      method699(var0, var3 + var1 - 1, var2, var4, var5);
      if(var3 >= 3) {
   ...
   @ObfuscatedName("du")
   public static void method702(int var0, int var1, int var2, int var3, int var4) {
      var2 -= var0;
      var3 -= var1;
      if(var3 == 0) {
         if(var2 >= 0) {
            method698(var0, var1, var2 + 1, var4);
         } else {
            method698(var0 + var2, var1, -var2 + 1, var4);
         }

      } else if(var2 == 0) {
         if(var3 >= 0) {
            method757(var0, var1, var3 + 1, var4);
         } else {
            method757(var0, var3 + var1, -var3 + 1, var4);
         }
   ...
   @ObfuscatedName("cz")
   public static void method686(int[] var0) {
   ...
   @ObfuscatedName("dr")
   public static void method695(int var0, int var1, int var2, int var3, int var4, int var5, byte[] var6, int var7, boolean var8) {
      int var9 = ItemContainer.clientInstance.getGraphicsPixelsWidth();
   ...
   @ObfuscatedName("cj")
   public static void method685(int var0, int var1, int var2, int var3) {
   ...
   @ObfuscatedName("ds")
   static void method689(int var0, int var1, int var2, int var3) {
      if(var2 == 0) {
         method712(var0, var1, var3);
      } else {
         if(var2 < 0) {
            var2 = -var2;
         }
   ...
   @ObfuscatedName("cl")
   public static void method687(int[] var0) {
   ...
   @ObfuscatedName("dg")
   public static void method690(int var0, int var1, int var2, int var3, int var4) {
      if(var4 != 0) {
         if(var4 == 256) {
            method689(var0, var1, var2, var3);
         } else {
            if(var2 < 0) {
               var2 = -var2;
            }
   ...
   @ObfuscatedName("dt")
   public static void method718(int var0, int var1, int var2, int var3, int var4, int var5, int var6, int var7) {
      int var8 = ItemContainer.clientInstance.getGraphicsPixelsWidth();
      int var9 = ItemContainer.clientInstance.getStartX();
      int var10 = ItemContainer.clientInstance.getStartY();
      int var11 = ItemContainer.clientInstance.getEndX();
   ...
   @ObfuscatedName("dk")
   public static void method704(int var0, int var1, int var2, int[] var3, int[] var4) {
   ...
   @ObfuscatedName("dq")
   public static void method692(int var0, int var1, int var2, int var3, int var4) {
      if(var0 < draw_region_x) {
         var2 -= draw_region_x - var0;
         var0 = draw_region_x;
      }
   ...
   @ObfuscatedName("dj")
   static void method699(int var0, int var1, int var2, int var3, int var4) {
      if(var1 >= drawingAreaTop && var1 < drawingAreaRight) {
         if(var0 < draw_region_x) {
            var2 -= draw_region_x - var0;
            var0 = draw_region_x;
   ...
   @ObfuscatedName("cu")
   public static void method701(int[] var0, int var1, int var2) {
      graphicsPixels = var0;
      graphicsPixelsWidth = var1;
      graphicsPixelsHeight = var2;
      method684(0, 0, var1, var2);
   }
   ...
   @ObfuscatedName("dx")
   public static void method757(int var0, int var1, int var2, int var3) {
      if(var0 >= draw_region_x && var0 < drawingAreaBottom) {
         if(var1 < drawingAreaTop) {
            var2 -= drawingAreaTop - var1;
            var1 = drawingAreaTop;
   ...
   @ObfuscatedName("dl")
   public static void method691(int var0, int var1, int var2, int var3, int var4, int var5) {
      if(var0 < draw_region_x) {
         var2 -= draw_region_x - var0;
         var0 = draw_region_x;
      }
   ...
   @ObfuscatedName("do")
   public static void method696(int var0, int var1, int var2, int var3, int var4) {
      method698(var0, var1, var2, var4);
      method698(var0, var3 + var1 - 1, var2, var4);
      method757(var0, var1, var3, var4);
      method757(var0 + var2 - 1, var1, var3, var4);
   }

   @ObfuscatedName("ce")
   public static void method684(int var0, int var1, int var2, int var3) {
      if(var0 < 0) {
         var0 = 0;
      }
